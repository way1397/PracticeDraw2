...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Bitmap bitmap1 = new BitmapFactory().decodeResource(getResources(), R.drawable.batman);
        Bitmap bitmap2 = new BitmapFactory().decodeResource(getResources(), R.drawable.batman_logo);
